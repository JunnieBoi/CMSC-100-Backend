...
// found a bug, forgot to add 'async' here
// if the 'async' keyword is missing, expect that this code block will behave randomly
describe("update todos using PUT(/todo)", async () => {
  let app;
  let authorization = "";
  const ids = [];
  const payload = {
